 ...
 * auther :zane
 * 修改记录：
 *      2025-10-24  fzj     修改支持标准umd格式打包；现在这种模式对标准化支持不高
 *      2025-10-24  fzj     将 _createClass等外部方法迁移到模块内部取
 *      2025-10-24  fzj     去掉require引入css依赖文件，交给外部自己处理
 */
; (function (global, factory) {
    /** 原始模块注入方法，非标准化umd写法，换成下面这个
