 ...
 */
export type ExtractComponentEvents<Events> = Events extends Record<string, unknown[]>
    ? (/* 不用约束必须有key，后续看情况
 ...
 */
export type ExtractComponentProps<Props> = Props extends Record<string, any> ? Props : undefined;
