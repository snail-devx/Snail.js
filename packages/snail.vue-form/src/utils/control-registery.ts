...
const defaultControls: ControlOptions[] = [
    { type: "Text", name: "单行文本框", renderComponent: wrapComponent(Text), settingComponent: wrapComponent(TextSetting) },
    { type: "TextArea", name: "多行文本框", renderComponent: wrapComponent(Text), settingComponent: wrapComponent(TextSetting) },
    { type: "Number", name: "数值", renderComponent: wrapComponent(Number), settingComponent: wrapComponent(NumberSetting) },
